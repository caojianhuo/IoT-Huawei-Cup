...
public class MqttDemo {
    //IoT平台mqtt对接地址
    private String serverIp = "327cafcd6c.st1.iotda-device.cn-north-4.myhuaweicloud.com";
    private int qosLevel = 1;
    private MqttAsyncClient client;
    // 创建设备时获得的deviceId，密钥（要替换为自己注册的设备ID与密钥）
    static String deviceId = "6460a08beb2ee73fc4d264f7_test123";
    static String secret = "a0472a77c4325728fafb0ab948b53169";
